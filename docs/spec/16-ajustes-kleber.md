...
Legenda de status: ⬜ pendente · 🟡 em andamento · ✅ feito.
...
- ⬜ **A1 — CRUD de agendas** com visualização por **profissional** e por
  **departamento** (ex.: Dra. Gabriela, especialista volante, hotel).
...
- ⬜ **A4** — **"Informar chegada do cliente"** dá **baixa/desativa** o evento no
  calendário **e notifica** o profissional.
...
- ⬜ **F1** — Reorganizar no padrão do concorrente (mais organizado): **total vendido**,
  **ticket médio**, **última venda**, **contatos**, **nota do cliente**, **dados de
  cadastro**, **animais cadastrados**.
- ⬜ **F2** — Botão **WhatsApp** direto (T5).
- ⬜ **F3** — Menu **"⋮"** ao lado do WhatsApp: convite para o portal, mensagem/SMS,
  **histórico de mensagens**, histórico de alteração, lembrete de vacina.
